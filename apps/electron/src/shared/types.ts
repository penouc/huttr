...
export const IPC_CHANNELS = {
  ...
  SETTINGS_GET_MODEL_API_KEYS: "settings:getModelApiKeys",
  SETTINGS_SET_MODEL_API_KEY: "settings:setModelApiKey",
...
export interface ElectronAPI {
  ...
  // Settings - Model API Keys (Minimax, GLM)
  getModelApiKeys(): Promise<ModelApiKeysInfo>;
  setModelApiKey(
    modelId: "minimax" | "glm" | "zenmux",
    apiKey: string | null,
  ): Promise<void>;
...
/**
 * Model-specific API keys info for settings
 */
export interface ModelApiKeysInfo {
  /** Whether Minimax API key is configured */
  hasMinimaxKey: boolean;
  /** Whether GLM API key is configured */
  hasGlmKey: boolean;
  /** Whether Zenmux API key is configured */
